            ...
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                ...
                <div className='max-w-80'>
                    ...
                    <div className='flex items-center mt-4'>
                        <input type="text" className='px-3 bg-white border border-gray-300 rounded-l outline-none h-9' placeholder='Your email' />
                        <button className='flex items-center justify-center bg-black rounded-r h-9 w-9 aspect-square'>
                            {/* Arrow icon */}
